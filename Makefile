...
# kubeheal.io/kubeheal-operator-bundle:$VERSION and kubeheal.io/kubeheal-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/takinosh/kubeheal-operator
...
ifeq (,$(shell which helm-operator 2>/dev/null))
	...
	curl -sSLo $(HELM_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.42.3/helm-operator_$(OS)_$(ARCH) ;\
